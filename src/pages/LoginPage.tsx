      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <img
            ...
            style={{
              ...
              filter: 'drop-shadow(0 6px 16px rgba(160,104,40,0.22))',
            }}
          />
          <div style={{ fontSize: 20, fontWeight: 900, color: '#4c2415', letterSpacing: '0.01em' }}>
            ישיבת פני מנחם
          </div>
          <div style={{ fontSize: 13, color: '#c8863f', fontWeight: 700, marginTop: 4, letterSpacing: '0.04em' }}>
            כניסה למערכת הניהול
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 14 }}>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#8b6544', marginBottom: 6 }}>
              אימייל
            </label>
            <input
              type="email"
